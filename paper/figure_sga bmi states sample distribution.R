...
write_csv(state_counts,"paper/table_sga bmi state sample distribution.csv")
...
figA %>% 
  ggsave(.,filename=paste0(path_sga_bmi_folder,"/figures/sga bmi state sample distribution.jpg"),width=5*1.685,height=5)
