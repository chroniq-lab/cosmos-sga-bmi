...
df = bind_rows(
               read_csv("sensitivity/sbsens001_regression coefficients of linear and binomial regression.csv"),
...
write_csv(table_coefs,"paper/table_coefficients excluding people older than 75 years.csv")
