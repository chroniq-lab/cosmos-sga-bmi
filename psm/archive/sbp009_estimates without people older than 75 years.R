...
coefs_model <- bind_rows(
  ...
  tidy_save_geeglm(sbp009_output$p3_output[[1]],exponentiate = FALSE) %>%
    mutate(outcome = sbp009_output$p3_output$outcome,
           model = sbp009_output$p3_output$model),
  ...
  tidy_save_geeglm(sbp009_output$m3_output[[1]],exponentiate = FALSE) %>%
    mutate(outcome = sbp009_output$m3_output$outcome,
           model = sbp009_output$m3_output$model),
  ...
  tidy_save_geeglm(sbp009_output$n3_output[[1]],exponentiate = TRUE) %>%
    mutate(outcome = sbp009_output$n3_output$outcome,
           model = sbp009_output$n3_output$model)
